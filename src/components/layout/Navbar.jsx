...
export default function Navbar() {
  return (
    <header className="bg-[#f3f4f8] py-4 sm:py-5">
      <Container className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-4 sm:gap-12">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-[22px] font-extrabold tracking-tight text-[#202430] sm:text-[30px]">QuickHire</span>
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-5">
          ...
          <Link
            to="/admin"
            className="inline-flex h-9 items-center rounded-none bg-[#4640de] px-4 text-[12px] font-semibold text-white transition hover:bg-[#3a34c9] sm:h-10 sm:px-6 sm:text-[13px]"
          >
            Sign Up
          </Link>
        </div>
